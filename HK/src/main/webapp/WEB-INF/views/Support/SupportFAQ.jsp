...
<body>
	...
	<table id="FAQmenutable">
		<tr>
						<td class="FAQmenutd">전체</td>
						<td class="FAQmenutd">회원</td>
						<td class="FAQmenutd">주문/결제</td>
						<td class="FAQmenutd">교환/환불</td>
						<td class="FAQmenutd">상품</td>
						<td class="FAQmenutd">상품수령</td>
						<td class="FAQmenutd">적립금/상품권</td>
						<td class="FAQmenutd">쿠폰</td>
		</tr>
		<tr>
			<td id="FAQquestiontd" colspan="8">
				<table id="FAQquestionTable">
					<tr>

						<td class ="FAQNumber">번호</td>
						<td class ="FAQCategory">분류</td>
						<td class ="FAQquestion">질문</td>
					</tr>
					<tr>
